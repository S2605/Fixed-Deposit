...
public class Excel_Utility {
	...
	public static ArrayList<Object[]> getDataFromexcel() {
		...
		try {
			String s = "C:\\Users\\s2605\\Desktop\\Excel_Sheet.xlsx";
		...
		for (int rowNum = 2; rowNum <= reader.getRowCount("Sheet1"); rowNum++) {
			...
			Object ob[] = { MobileNo, pincode, EmailId, verifyOtp, amount_input_fd1, tenure_input_fd2,
					Select_Interest_Payout, Are_you_a_senior_citizen1, Iteration, INDEX, s1_depositorPAN,
					s1_depositortitle, s1_depositorFName, s1_depositorMName, s1_depositorLName, s1_depositorDOB,
					s1_depositorEmail, s1_depositorGuardianPAN, s1_depositorGuardianMName, s1_depositorGuardianEmail,
					Documenttype, DocumentNo, up_ckyc_frontpic, up_ckyc_backpic, Profie_Upload, s3_Documentnoo,
					s3_idproof, s3_addrline1, s3_addrline2, s3_area, s3_city, s3_state, s3_pincode, s4_accountno,
					s4_confaccountno, banknn, bal, ifsccodes, s4_ifsc, s4_branch, s4_bankname, s4_acctype,
					s4_accholdername, ocrChkUpload, s5_Occupation, s5_Marital, s5_Maturity_ins, s5_spouseName,
	...
	public static void writeinexcel(String value, int INDEX) throws Exception {
		File fis = new File(
				"C:\\Users\\s2605\\Desktop\\Excel_Sheet.xlsx");
