...
public class Personal_Details_Page_Xpaths extends LibGlobal {
	...
	@FindBy(xpath = "(//input[@class='file-btn'])[2]")
	...
	@FindBy(xpath = "(//a[@class=\"uploada modal-btn\"])[2]")
	...
	@FindBy(id = "step-def_3")
	private WebElement step_def_3;

	public WebElement getStep_def_3() {
		return step_def_3;
	}
}
