...
public class Excel_Utility {
	...
	public static ArrayList<Object[]> getDataFromexcel() {
		...
		try {
			String s = "C:\\Users\\s2605\\Desktop\\jar and exe\\Single_Data_Excel_Sheet.xlsx";
		...
		for (int rowNum = 2; rowNum <= reader.getRowCount("Sheet1"); rowNum++) {
			...
			// String S1_depositorGuardianPAN = reader.getCellData("Sheet1",
			// "S1_depositorGuardianPAN", rowNum);
			// String S1_depositorGuardianMName = reader.getCellData("Sheet1",
			// "S1_depositorGuardianMName", rowNum);
			// String S1_depositorGuardianEmail = reader.getCellData("Sheet1",
			// "S1_depositorGuardianEmail", rowNum);
			...
			// String Guard_Documenttype = reader.getCellData("Sheet1",
			// "Guard_Documenttype", rowNum);
			// String Guard_DocumentNo = reader.getCellData("Sheet1", "Guard_DocumentNo",
			// rowNum);
			// String Guard_up_ckyc_frontpic = reader.getCellData("Sheet1",
			// "Guard_up_ckyc_frontpic", rowNum);
			// String Guard_up_ckyc_backpic = reader.getCellData("Sheet1",
			// "Guard_up_ckyc_backpic", rowNum);
			...
			// String S3_guard_addrline1 = reader.getCellData("Sheet1",
			// "S3_guard_addrline1", rowNum);
			// String S3_guard_addrline2 = reader.getCellData("Sheet1",
			// "S3_guard_addrline2", rowNum);
			// String S3_guard_pincode = reader.getCellData("Sheet1", "S3_guard_pincode",
			// rowNum);
			// String Guardian_photo = reader.getCellData("Sheet1", "Guardian_photo",
			// rowNum);
			...
			String S4_accountno1 = reader.getCellData("Sheet1", "S4_accountno1", rowNum);
			String S4_confaccountno1 = reader.getCellData("Sheet1", "S4_confaccountno1", rowNum);
			String Banknn1 = reader.getCellData("Sheet1", "Banknn1", rowNum);
			String Bal1 = reader.getCellData("Sheet1", "Bal1", rowNum);
			String Ifsccodes1 = reader.getCellData("Sheet1", "Ifsccodes1", rowNum);
			String S4_acctype1 = reader.getCellData("Sheet1", "S4_acctype1", rowNum);
			String S4_accholdername1 = reader.getCellData("Sheet1", "S4_accholdername1", rowNum);
			...
			Object ob[] = { INDEX, Iterations, MobileNo, PinCode, EmailID, VerifyOtp, Amount_input_fd, Tenure_input_fd,
					Select_Interest_Payout, S1_depositorPAN, S1_depositorMName, S1_depositorEmail, Documenttype,
					DocumentNo, Up_ckyc_frontpic, Up_ckyc_backpic, S3_addrline1, S3_addrline2, S3_pincode,
					Profie_Upload, S4_accountno, S4_confaccountno, Banknn, Bal, Ifsccodes, S4_acctype, S4_accholdername,
					OcrChkUpload, S4_accountno1, S4_confaccountno1, Banknn1, Bal1, Ifsccodes1, S4_acctype1,
					S4_accholdername1, S5_Occupation, S5_Marital, S5_Maturity_ins, S5_spouseName, S5_fatherName,
					TDS_Certificate, S5_taxact, S5_FinancialYear, S5_EstimatedIncome, S5_esttotincome, S5_formsfilled,
					S5_AggregateAmount, Add_Nominee, S5_nomineeRelation, S5_nomineetitle, s5_nomineeFname,
					S5_nomineeFname, S5_nomineeLname, S5_nomineeDOB, Nominee_address_same_as_Applicant_address,
					S5_nomadd1, S5_nomadd2, S5_nomarea, S5_nomcity, S5_nomstate, S5_nompincode, Others, S5_othersNmae,
					Marital_Status };
			myData.add(ob);
		}
		return myData;
	...
	public static void writeinexcel(String value, int INDEX) throws Exception {
		File fis = new File("C:\\Users\\s2605\\Desktop\\jar and exe\\Single_Data_Excel_Sheet.xlsx");
